	...
	private void logar() {
		...
		try {
			...
			if (resultadoExecucao.next()) {
				...
				//Fechar a janel de Login assim que a janela Home abrir (automaticamente)
				dispose();
			
			}
			
			else {
			    //Criar um alerta (pop-up) que informe ao usuário que o login e/ou senha estão inválidos 
